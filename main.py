...
if 'p_url' not in st.session_state:
    st.session_state.p_url = 'Example: https://open.spotify.com/playlist/16B80gKqceXEOjMyt9bHFu?si=1a530b4f6284403f'
def update_playlist_url():
    st.session_state.p_url = st.session_state.playlist_url

if 's_url' not in st.session_state:
    st.session_state.s_url = 'Example: https://open.spotify.com/track/26wLOs3ZuHJa2Ihhx6QIE6?si=6b5191af174343bb'
def update_song_url():
...
def About_page():
    ...
    """
    [Github](https://github.com/AnvitaNavuluri)  [Linkedin](https://www.linkedin.com/in/anvitanavuluri/) Email : navulurianvita@gmail.com
    """
    st.subheader('Recommendation models')
    """
    Three models have been implemented:
    - Model 1 which gives the genre more weight than the audio features
    ...
    """
    For this project, I'm using a subset consisting of 10,000 playlists from the Million Playlist Dataset, which, as its name implies, consists of one million playlists.
